...
Версия 0.2.0. Четыре режима — неоднозначность, пунктуация, нормы, переписывание — у каждого свой формат отчёта. Семь референсов на русском: от типологии синтаксической неоднозначности до деонтической модальности и каталога дефектов формы. Скилл проверен на наборе из 121 размеченного примера (`evals/`), включая сделочные и корпоративные сценарии — заверения об обстоятельствах, возмещение потерь, опционы, эскроу, MAC-оговорки, условия закрытия — и многодефектные тексты; корректные примеры подтверждают отсутствие ложных срабатываний. Страница проекта — **[sky-magenta.github.io/pravo-grammatika](https://sky-magenta.github.io/pravo-grammatika/)**. Лицензия — **MIT**.
